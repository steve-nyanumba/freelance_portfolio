        ...
        <div class="col-md-6">
          <div class="card card-secondary">
            <div class="card-header">
              <h3 class="card-title">Create your Experience Item</h3>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="number" id="start_year" class="form-control" name="start_year" required>
              </div>
              <div class="form-group">
                <label for="end_year">End Year</label>
                <input type="number" id="end_year" class="form-control" name="end_year" required>
              </div>
              <div class="form-group">
